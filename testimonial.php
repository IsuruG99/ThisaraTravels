...
<body>
        ...
        <div class="user-data-container">
            <?php foreach ($cursor as $doc): ?>
                <div class="user-data">
                    ...
                    <!-- Star rating -->
                    <div class="rating">
                        <?php for ($i = 0; $i < $doc['ReviewCount']; $i++)
                    ...
                    <div class="like-dislike-icons">
                        <i class="fas fa-heart like-icon"></i> <span
                            class="like-count"><?= htmlspecialchars($doc['likeCount'] ?? 0) ?></span>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <?php else: ?>
        <div class="text-center my-5">
            <p><a href="auth.php">Login</a> to post a review.</p>
        </div>
    <?php endif; ?>
